...
namespace Group12_iCAREAPP.Controllers
{
    public class DrugsDictionariesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,name,description")] DrugsDictionary drugsDictionary)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,name,description")] DrugsDictionary drugsDictionary)
        {
            if (ModelState.IsValid)
            {
